...
function dvwaHtmlEcho($pPage)
{
	...
	if (dvwaIsLoggedIn()) {
		...
		$menuBlocks['PTIT'] = array();
		$menuBlocks['PTIT'][] = array('id' => 'bac1', 'name' => 'Broken Access Control 1', 'url' => 'vulnerabilities/broken_access_control_1/');
		$menuBlocks['PTIT'][] = array('id' => 'bac2', 'name' => 'Broken Access Control 2', 'url' => 'vulnerabilities/broken_access_control_2/');
		$menuBlocks['PTIT'][] = array('id' => 'redirect2', 'name' => 'Open Redirect 2', 'url' => 'vulnerabilities/open_redirect_2/index.php');
		$menuBlocks['PTIT'][] = array('id' => 'ssti', 'name' => 'Server Side Template Injection', 'url' => 'vulnerabilities/server_side_template_injection/');
		$menuBlocks['PTIT'][] = array('id' => 'untrusted_upload_file', 'name' => 'Untrusted Upload file', 'url' => 'vulnerabilities/untrusted_upload_file/');
		$menuBlocks['PTIT'][] = array('id' => 'host_header_authentication_bypass', 'name' => 'Host Header Authentication Bypass', 'url' => 'vulnerabilities/host-header-authentication-bypass/');
		$menuBlocks['PTIT'][] = array('id' => 'password_reset_poisoning', 'name' => 'Password Reset Poisoning', 'url' => 'vulnerabilities/password-reset-poisoning/');
		$menuBlocks['PTIT'][] = array('id' => 'sqli_get', 'name' => 'SQL Injection GET Method', 'url' => 'vulnerabilities/sql-injection-search/');
		$menuBlocks['PTIT'][] = array('id' => 'sqli_post', 'name' => 'SQL Injection POST Method', 'url' => 'vulnerabilities/sql-injection-login/');
		$menuBlocks['PTIT'][] = array('id' => 'xssr', 'name' => 'XSS Injection', 'url' => 'vulnerabilities/xss-injection/');
		$menuBlocks['PTIT'][] = array('id' => 'bypassing-samesite-restrictions', 'name' => 'Bypassing Samesite Restrictions', 'url' => 'vulnerabilities/csrf-lab/bypassing-samesite-restrictions/');
		$menuBlocks['PTIT'][] = array('id' => 'bypassing-token-validation', 'name' => 'Bypassing Token Validation', 'url' => 'vulnerabilities/csrf-lab/bypassing-token-validation/');
		$menuBlocks['PTIT'][] = array('id' => 'lab-no-defenses', 'name' => 'Lab No Defense', 'url' => 'vulnerabilities/csrf-lab/lab-no-defenses/');
		$menuBlocks['PTIT'][] = array('id' => 'brute-nolimit', 'name' => 'Brute Force No Limit', 'url' => 'vulnerabilities/brute-force/no-limit/');
		$menuBlocks['PTIT'][] = array('id' => 'brute-rate-limit', 'name' => 'Brute Force Rate Limit', 'url' => 'vulnerabilities/brute-force/rate-limit');
		$menuBlocks['PTIT'][] = array('id' => 'crypto', 'name' => 'Encrypt Request, Response', 'url' => 'vulnerabilities/crypto/');
		$menuBlocks['PTIT'][] = array('id' => 'ssrf1', 'name' => 'SSRF 1', 'url' => 'vulnerabilities/ssrf1/');
		$menuBlocks['PTIT'][] = array('id' => 'ssrf2', 'name' => 'SSRF 2', 'url' => 'vulnerabilities/ssrf2/');
		$menuBlocks['PTIT'][] = array('id' => 'cors', 'name' => 'CORS Misconfiguration', 'url' => 'vulnerabilities/cors/');
...
function dvwaDatabaseConnect()
{
	...
	if ($DBMS == 'MySQL') {
		if (
			!@($GLOBALS["___mysqli_ston"] = mysqli_connect($_DVWA['db_server'],  $_DVWA['db_user'],  $_DVWA['db_password'], "", $_DVWA['db_port']))
